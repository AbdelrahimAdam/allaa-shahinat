...
const Contact = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>اتصل بنا - علاء الدين شاحنات - قطع غيار رينو</title>
        <meta name="description" content="تواصل مع فريق علاء الدين شاحنات للحصول على استشارات فنية وطلبات قطع غيار شاحنات رينو الأصلية. هاتف: +249-999-929966، واتساب، بريد إلكتروني." />
        <meta name="keywords" content="اتصل بنا, علاء الدين شاحنات, قطع غيار رينو, استشارات فنية, واتساب, هاتف, دعم فني" />
        <link rel="canonical" href="https://renault-trucks-parts.com/contact" />
        
        {/* Open Graph */}
        <meta property="og:title" content="اتصل بنا - علاء الدين شاحنات" />
        <meta property="og:description" content="تواصل معنا للحصول على استشارات فنية وطلبات قطع غيار رينو" />
        <meta property="og:url" content="https://renault-trucks-parts.com/contact" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "ContactPage",
            "name": "اتصل بنا - علاء الدين شاحنات",
            "description": "صفحة التواصل مع متجر قطع غيار شاحنات رينو",
            "url": "https://renault-trucks-parts.com/contact",
            "telephone": "+249-999-929966",
            "email": "info@renault-trucks-egypt.com",
